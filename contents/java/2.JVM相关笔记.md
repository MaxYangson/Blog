...
<font color="red">**用于存放已被加载的类信息、常量、静态变量、即时编译器编译后的代码等数据。**</font>
...
[堆内存](https://so.csdn.net/so/search?q=堆内存&spm=1001.2101.3001.7020)溢出(OutOfMemoryError：java heap space)
